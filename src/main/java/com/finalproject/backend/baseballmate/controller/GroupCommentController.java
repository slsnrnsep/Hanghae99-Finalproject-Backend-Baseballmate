...
public class GroupCommentController {
    ...
    public MsgResponseDto updateGroupComment(
            @PathVariable("groupId") Long groupid,
            @PathVariable("commentId") Long commentid,
            @RequestBody GroupCommentRequestDto requestDto,
    ...
    public MsgResponseDto delteGroupComment(
    ...
    public MsgResponseDto createGroupComment(
            @RequestBody GroupCommentRequestDto commentRequestDto,
            @PathVariable("groupId") Long groupId,
            @AuthenticationPrincipal UserDetailsImpl userDetails)
    {
        if(userDetails == null)
