...
public class GroupCommentService {
    ...
    @Transactional
   public MsgResponseDto createComment(GroupCommentRequestDto groupCommentRequestDto, Long groupId, UserDetailsImpl userDetails) {
        if(userDetails == null)
        {
   ...
   @Transactional
    public MsgResponseDto updateGroupComment(Long groupid, Long commentid, GroupCommentRequestDto requestDto, UserDetailsImpl userDetails) {
       if(userDetails == null)
       {
           throw new IllegalArgumentException("로그인 하신 후 이용해주세요.");
       }
    ...
    @Transactional
    public MsgResponseDto deleteGroupComment(Long id, UserDetailsImpl userDetails) {
        if(userDetails == null)
        {
            throw new IllegalArgumentException("로그인 하신 후 이용해주세요.");
        }
