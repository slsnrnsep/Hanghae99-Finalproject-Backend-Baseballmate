...
public class PhoneService {
    ...
    public int  sendMessage(PhoneRequstDto requstDto, User user) {
        ...
        user.setPhoneNumber(requstDto.getPhoneNumber());
    ...
    public void confirmNumChk(UserDetailsImpl userDetails, PhoneRequstDto requstDto) {
        ...
        int  ranNumChk = phoneService.sendMessage(requstDto,user);
